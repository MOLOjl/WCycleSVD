...
void EVD_(double *dev_jointG, double *dev_AiAj, double *dev_AiAi, double* dev_AjAj, double *dev_A, double *dev_V, int *dev_pairsOfEVD, int p, int q, int height, int width, int *dev_roundRobin, int batch, int k, int slice, int sliceNum, int iter)
{
    if(k>24 && gm_V==NULL){
