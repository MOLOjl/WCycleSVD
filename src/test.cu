...
// generate matrix set
void before_test(){
    int h_array[22] = {8, 8, 16, 16, 24, 24, 32, 32, 32, 32, 64, 64, 128, 128, 256, 256, 512, 512, 1024, 1024, 1024, 1024};
    int w_array[22] = {8, 32, 16, 32, 24, 32, 8, 16, 24, 32, 64, 1024, 128, 1024, 256, 1024, 512, 1024, 64, 128, 512, 1024};
